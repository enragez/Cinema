...
public class EditModel : PageModel
{
    ...
    public async Task<IActionResult> OnGetAsync(string? id)
    {
        ...
        UserModel = new UserEditModel
        {
            ...
            IsCashier = roleNames.Any(r => r == "Кассир"),
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        switch (UserModel.IsCashier)
        {
            case true when !await _userManager.IsInRoleAsync(user, "Кассир"):
                await _userManager.AddToRoleAsync(user, "Кассир");
                break;
            case false when await _userManager.IsInRoleAsync(user, "Кассир"):
                await _userManager.RemoveFromRoleAsync(user, "Кассир");
                break;
        }
